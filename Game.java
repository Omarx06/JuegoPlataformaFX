package com.example.juegojavafx.juegojavafx;
...
public class Game {
    ...
    private void init() {
        archivoJuego = new ArchivoJuego("src/datos/progreso.txt");
    ...
    private void actualizar(double delta) {
        // input
        if (keys.contains(KeyCode.A)) jugador.moverIzquierda();
        if (keys.contains(KeyCode.D)) jugador.moverDerecha();
